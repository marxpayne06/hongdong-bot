...
# ── Config ────────────────────────────────────────────────────────────────────
# Set BOT_TOKEN in Koyeb dashboard → Service → Environment Variables
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8633914734:AAHCb01yBMbZd1Cpamcm6BNvsBTOaysGM3Y")
...
# ── Health-check server (required by Koyeb to confirm app is running) ─────────
